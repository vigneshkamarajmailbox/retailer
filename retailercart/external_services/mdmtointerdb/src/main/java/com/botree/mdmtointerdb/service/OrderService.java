...
public class OrderService {
     ...
     */
    public OrderService(final DAORepository repositoryIn,
    ...
    public void convertTransactionData(final List list,
        ...
        if (!orderBookingHeader.isEmpty()) {
            ...
            var mappingList = repository.queryForList(this.queryService.get(StringConstants.FETCH_MASTER_MAPPING),
            ...
            repository.bulkInsert(this.queryService.get(StringConstants.INSERT_ORDER_HEADER), orderHeaders);
            repository.bulkInsert(this.queryService.get(StringConstants.INSERT_ORDER_DETAILS), orderDetails);
            repository.bulkInsert(this.queryService.get(StringConstants.INSERT_ORDER_CHANGELOG), orderHeaders);
        }
    }
