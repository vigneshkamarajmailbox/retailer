...
public class ExtendedCurrency {
    private static final ExtendedCurrency[] CURRENCIES = {
    ...
    private static final String TAG = ExtendedCurrency.class.getSimpleName();
    private List<ExtendedCurrency> allCurrenciesList;
    private static ExtendedCurrency ourInstance = new ExtendedCurrency();
    private String code;
    private String name;
    private String symbol;
    private int flag = -1;

    private ExtendedCurrency(String code, String name, String symbol, int flag) {
        this.code = code;
        this.name = name;
        this.symbol = symbol;
        this.flag = flag;
    ...
    public static ExtendedCurrency getOurInstance() {
        return ourInstance;
    }
    private ExtendedCurrency() {}

    public List<ExtendedCurrency> getAllCurrencies() {
    ...
    public void loadFlagByCode(Context context) {
        ...
        try {
            this.flag = context.getResources()
                    .getIdentifier("flag_" + this.code.toLowerCase(Locale.getDefault()), "drawable",
                            context.getPackageName());
        } catch (Exception e) {
            Log.e(TAG, "loadFlagByCode: " + e.getMessage(),e);
            this.flag = -1;
        }
    }
