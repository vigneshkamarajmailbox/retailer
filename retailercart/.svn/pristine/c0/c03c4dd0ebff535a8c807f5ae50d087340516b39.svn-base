...
#### 6.0.0
Provides a remastered version with a new layout and new themes. In addition brings support for Angular 6 and RxJS 6, adds theming for new components in PrimeNG such as the new TreeTable
and improves behaviors of the layout menus.
- Install PrimeIcons package.
- Update layout css files.
- Update theme css files.
- Update app.* files for the new layout structure.
