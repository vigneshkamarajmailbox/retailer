...
public class TransactionService {
     ...
     * @return Login Referral Entity
     */
    private List<OrderReferralEntity> fetchOrderReferral(final TransactionModel model) {
        return repository.queryForList(queryService.get(
                        StringConstants.FETCH_ORDER_REFERRAL),
                Map.of(StringConstants.CONST_PARAM_1, model.getCmpCode()), OrderReferralEntity.class);
    }
